...
public class SHAUtil {
    ...
    public static String shaEncode(String inStr,String pwd) throws Exception {
	   ...
	   * @return
	   */
    public static String getSignatureString(Map<String, Object> params){
    	...
    	try {
			String signature = shaEncode(sbuilder.toString(),PropertiesUtil.getProperty("ecommerce_signature_key"));
